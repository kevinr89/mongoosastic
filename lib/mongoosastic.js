...
const forceString = settings.es_forceString || "string";

function isString (subject) {
  return typeof subject === forceString
}

function isStringArray (arr) {
  return arr.filter && arr.length === (arr.filter(item => typeof item === forceString)).length
}
